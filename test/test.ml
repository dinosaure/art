...
let test10 =
  ...
  Art.insert tree
    (Art.key
       "\021\n\
        \135\131\2105\161=\142\028\152\006\031\188\191\201\134\194Fu\253\132\1279v_\200&\238")
    2;
  Art.insert tree (Art.key "\182\206\219:n4\156\173Mu\012\223;\215\197") 3;
  Art.insert tree (Art.key "bG>\229") 4;
  Art.insert tree
    (Art.key
       "[\183\191\201\169M\210\183\015oK%\252\021\187\158e\138\202\193\129\145-")
    5;
  Art.insert tree
    (Art.key
       "\191\175\151\144\012\226\211Y\182\226 \
        +\245\153\204\002\148\149\219^4Aq\189\201\003")
    6;
  Art.insert tree
    (Art.key
       "\182\024\023\145\178\206\\wW0\138\157\223\184]\137g\031\029\"k\132")
    7;
  ...
  Art.insert tree
    (Art.key "\207\251y\235\214\164`6\017)h(  \179\215]5'\151\178\208")
    13;
  Art.insert tree (Art.key "\n\209 \\\235z^\183") 14;
  Art.insert tree (Art.key "]\218") 15;
  Art.insert tree (Art.key "\127\252N\155\2162\145") 16;
  Art.insert tree
    (Art.key "|V\232Z\210&O\234\197\229w\127O\250\154h\236\224\254")
    17;
  ...
  Art.insert tree
    (Art.key
       "\195:\018\180 \
        \004\152\018\143\231z\212\255\024W\159\147|\006\2069Z\218\006\006\241\166u\167N\024\019'")
    25;
  ...
  Art.insert tree
    (Art.key "\224o;Zu\192\248[\144Q?\167\131\194\1608\014j\224\254")
    32;
  Art.insert tree (Art.key "\219jsv\n\226") 33;
  Art.insert tree (Art.key "\003@3\150\229\tJ\134") 34;
  Art.insert tree (Art.key "\022$") 35;
  Art.insert tree
    (Art.key "\198\156\241\138ga9\239\237\212\151\189\1311\220\247")
    36;
  Art.insert tree
    (Art.key "\210\156\146s\212a\187\244Up\022U\019\207\179\244")
    37;
  Art.insert tree
    (Art.key "\145\015\001\210\n\142\215P\003A\137k\218\130>\b\017")
    38;
  ...
  Art.insert tree
    (Art.key
       "\184O\129\147\031\225\168>\182\210\252\211\255!\234\157\134\153\198E\169w\217")
    41;
  Art.insert tree
    (Art.key "\157z\229L\236]\2548\015w\174V\011\250\n\135~U^\139#\180")
    42;
...
let test14 =
  ...
  Alcotest.check_raises
    (k4 :> string)
    Not_found
    (fun () -> ignore @@ Art.find tree k4);
  Alcotest.check_raises
    (k5 :> string)
    Not_found
    (fun () -> ignore @@ Art.find tree k5)

let test15 =
  Alcotest.test_case "test15" `Quick @@ fun () ->
  let ks =
    Array.init 200 (function
      | 0 -> Art.key ""
      | i -> Art.key (String.make 1 (Char.unsafe_chr i)))
  in
  let tree = Art.make () in
  Array.iteri (fun i k -> Art.insert tree k i) ks;
  Alcotest.check_raises "not found" Not_found (fun () ->
      ignore @@ Art.find tree (Art.key "\255"))

let key =
  Alcotest.testable
    (fun ppf (v : Art.key) -> Fmt.pf ppf "%S" (v :> string))
...
let test17 =
  ...
  let ks =
    Array.init 16 (fun i -> Art.key (String.make 1 (Char.unsafe_chr (i + 1))))
  in
  let tree = Art.make () in
  Array.iteri (fun i k -> Art.insert tree k i) ks;
  Alcotest.(check (pair key int))
    "minimum" (Art.minimum tree)
    (Art.key "\001", 0)

let test18 =
  Alcotest.test_case "test18" `Quick @@ fun () ->
  let ks =
    Array.init 48 (fun i -> Art.key (String.make 1 (Char.unsafe_chr (i + 48))))
  in
  let tree = Art.make () in
  Array.iteri (fun i k -> Art.insert tree k i) ks;
  Alcotest.(check (pair key int))
...
let test19 =
  ...
  let ks =
    Array.init 256 @@ function
    | 0 -> Art.key ""
    | n -> Art.key (String.make 1 (Char.unsafe_chr n))
  in
  let tree = Art.make () in
  Array.iteri (fun i k -> Art.insert tree k i) ks;
...
let test20 =
  ...
  let tree = Art.make () in
  Alcotest.check_raises "minimum" (Invalid_argument "empty tree") @@ fun () ->
  ignore (Art.minimum tree)
...
let test23 =
  ...
  let tree = Art.make () in
  Alcotest.check_raises "remove" Not_found (fun () ->
      Art.remove tree (Art.key "a"));
  Art.insert tree (Art.key "a") ();
  Art.insert tree (Art.key "b") ();
  Alcotest.check_raises "remove" Not_found (fun () ->
      Art.remove tree (Art.key "c"));
  for i = 0x7f to 0xff do
    Art.insert tree (Art.key (String.make 1 (Char.unsafe_chr i))) ()
  done;
  Alcotest.check_raises "remove" Not_found (fun () ->
      Art.remove tree (Art.key "c"));
  Art.remove tree (Art.key "a");
  Alcotest.check_raises "find" Not_found (fun () ->
      ignore (Art.find tree (Art.key "a")))
...
let test24 =
  ...
  Alcotest.(check unit) "find" (Art.find tree (Art.key "foo")) ();
  Alcotest.check_raises "find" Not_found (fun () ->
      ignore (Art.find tree (Art.key "foobar")))
...
let test25 =
  ...
  Alcotest.(check int) "find" (Art.find tree (Art.key "foobar!")) 2;
  Alcotest.check_raises "find" Not_found (fun () ->
      ignore (Art.find tree (Art.key "foo")))

let test26 =
  Alcotest.test_case "test26" `Quick @@ fun () ->
  let tree = Art.make () in
  for i = 0 to 4 do
    Art.insert tree (Art.key (String.make 1 (Char.chr (i + 48)))) ()
  done;
  ...
  Alcotest.(check unit) "find" (Art.find tree (Art.key "2")) ();
  Alcotest.check_raises "find" Not_found (fun () ->
      ignore (Art.find tree (Art.key "4")));
  Alcotest.check_raises "find" Not_found (fun () ->
      ignore (Art.find tree (Art.key "3")))

let test27 =
  Alcotest.test_case "test27" `Quick @@ fun () ->
  let tree = Art.make () in
  for i = 0 to 17 do
    Art.insert tree (Art.key (String.make 1 (Char.chr (i + 65)))) ()
  done;
...
let test28 =
  ...
  let tree = Art.make () in
  for i = 1 to 50 do
    Art.insert tree (Art.key (String.make 1 (Char.chr i))) ()
  done;
  for i = 1 to 38 do
    Alcotest.(check pass)
      "remove"
      (Art.remove tree (Art.key (String.make 1 (Char.chr i))))
      ()
  done
...
let test29 =
  ...
  let tree = Art.make () in
  for i = 1 to 50 do
    Art.insert tree (Art.key (String.make 1 (Char.chr i))) i
  done;
...
module Caml_test = struct
  ...
  let domain_tm t m =
    try
      Art.iter ~f:(fun k _ () -> if not (Map.mem k m) then raise Not_found) () t;
      true
    with Not_found -> false
  ...
  let test data =
    ...
    Alcotest.(check bool)
      "insert"
      (incl_mt !map tree && domain_tm tree !map)
      true;
    ...
    Fmt.pr "map: @[<hov>%a@].\n%!"
      Fmt.(
        Dump.iter_bindings Map.iter (any "map")
          (using (fun (x : Art.key) -> (x :> string)) (fmt "%S"))
          int)
      !map;
    Fmt.pr "art: @[<hov>%a@].\n%!" (Art.pp Fmt.int) tree;
...
let test30 =
  let data =
    [|
      ( Art.key
          ":v\171\225]\154\143x\235#\162\182+\184\196\178'e\220R\238\2506b\245w\231'\011\003\150",
        0 );
      ( Art.key
          "\185\026\129\171^\b\254\236\1290\169.\247\178\022\240\147%M\133 \
           x\229\020\177.\236\139\017\224\255!\249\201\153K2u\210\247\019\226F\019Q\029\224\1348\194a\240\168\030\217kIsJm\249\247\031{",
        1 );
      ( Art.key
          "\164\165\128\156\213\157\236Jx\180\025\186\156F<\215\1905`\246n\007G\206\026b\242\210-Iy\021|@\224cO[\194\213&\r\172\185\185$51Lz\244;\172Ky\195\237s\177\199>\129q\243",
        2 );
      ( Art.key
          "\r\183\028)\128N\227\236\253\234\146\248\206Q\188\145+\139\2001\197,\250\182vr\026\217\246\142w\159U\230\206x\020\221`\168\198\200\1372E\170\139,Zu.h\250\026\190*\131@b\019\228v\137C",
        3 );
      ( Art.key
          "MX\015\219v\232\187\22041\241\175 \
           \201\200'\"\133\238D\246\232\156(\241\t\141\187\185\019\165\193\129z\214\140\153\236]\127\172\255\159\135W\b\250y\255\202}\b#\134vMR\150\148!\014K\139\184",
        4 );
      (Art.key "\155\200:", 5);
    |]
  in
...
let test32 =
  ...
  Art.insert t
    (Art.unsafe_key
       "\253w\247R\241\002'\240E2K\186\250^}*\159\232\255\148\187\248\144\167\194\165\162j1\154\018\140\139\137\189MV;\232\139Z\237\238,n\240\227\t_\191\152\243\142\184\188\012\150\187+\185/\006\233\192")
    0;
  Art.insert t
    (Art.unsafe_key
       "\131\206P\133\150\213\b{\005,-\194\209\165*B\227\135B\212N\027Z6\214\015\254\253F*#QM\t>~\025\018\181d\232\253\219\140\240\rU3A\253\242]nE\207\156a\128\139\0195\137W\136")
    1;
  Art.insert t
    (Art.unsafe_key
       ",Q2$\163d\012\007\220=\199p\t\238\189\152\193\134N\150\018\246$\t\027\\5%\184\020\210\024G\138\144\2532\165mx\219\210\161\167?=\194\212\199)\211\022P\027\153L\158[KX\140\212)\011")
    2;
  Art.insert t
    (Art.unsafe_key
       "\236(F\"\248\241\213s\015Q\2515jc\238\235\224V\184\138\156x\138\029\017\249\188N\219\145+\028\243Ni\b\1444\n\
        U\155J\1880\146\t\192=\196\021!\161\1337r\247\027\254\132\213w\254\152\155")
    3;
  Art.insert t
    (Art.unsafe_key
       "\191*\134\\\\\220\n\
        \216\247M\193\172\015\012J\233\219\004+\171K \
        \161\240\0300\020%\180p\132\223\228\018\149\205\192\023\201\128\016&\146\155\017\2067\026\248\180\142\146\164+R\220W\165|K\137\180\199b")
    4;
  Art.remove t
    (Art.unsafe_key
       ",Q2$\163d\012\007\220=\199p\t\238\189\152\193\134N\150\018\246$\t\027\\5%\184\020\210\024G\138\144\2532\165mx\219\210\161\167?=\194\212\199)\211\022P\027\153L\158[KX\140\212)\011");
...
let test33 =
  ...
  Art.insert t (Art.unsafe_key "127.0.0.1:33658") 0;
  (try
     Art.remove t (Art.unsafe_key "127.0.0.1:33660");
     Alcotest.fail "127.0.0.1:33660 does not exist"
...
let test34 =
  ...
  let lst =
    Art.prefix_iter
      ~prefix:(Art.unsafe_key "127.0.0.1")
      ~f:(fun key _ acc -> (key :> string) :: acc)
      [] t
  in
...
let test35 =
  ...
  let k1 =
    k
      "\139\139\139\139\011\137\139\139\139\146\139\139\255\255\255\127\139\139\139\139\139\139"
  in
  let k2 =
    k
      "\139\139\139\139\011\137\139\139\139\146\139\139\255\255\255\127\139\139\139\139\139\139\002"
  in
  Art.insert t k0 0;
  Art.insert t k1 1;
  Art.insert t k2 2;
...
module Ordered = struct
  ...
  let compare (a : t) (b : t) = String.compare (a :> string) (b :> string)
end
...
let test38 =
  ...
  let k0 =
    k
      "}}}}}}}}}}}}}}t}}}}}}\177\177\177\164\151\002\255\127}}}}}}}}}}}}}}\151\002\255\127}}}}}}}}}}}}t}}}}"
  in
  let k1 =
    k "}}}}}}}}}}}}}}t}}}}}}\177\177\177\177\151\002\255\127}}}}}}}}}}}}}}}}c"
  in
  let k2 = k "}}}}}}}}}}}}" in
  Art.insert t k0 0;
  Art.insert t k1 1;
...
let random_integers num range =
  ...
  for i = 0 to num - 1 do
    data.(i) <- (Art.key (string_of_int (Random.int range)), i)
  done;
  data
  ...
  Alcotest.run "art"
    [
      ...
      ( "caml",
        [
          Caml_test.test
            Art.[| (key "0", 0); (key "1", 1); (key "2", 2); (key "3", 3) |];
          Caml_test.test
            Art.[| (key "3", 3); (key "2", 2); (key "1", 1); (key "0", 0) |];
          test30;
